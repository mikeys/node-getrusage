...
NAN_METHOD(GetChildrenSystemTime) {
    struct rusage ru;
    getrusage(RUSAGE_CHILDREN, &ru);
...
NAN_MODULE_INIT(Init) {
    SetMethod(target, "getUsage", GetUsage);
    SetMethod(target, "getCPUTime", GetCPUTime);
    SetMethod(target, "getSystemTime", GetSystemTime);
    SetMethod(target, "getChildrenUsage", GetChildrenUsage);
    SetMethod(target, "getChildrenCPUTime", GetChildrenCPUTime);
    SetMethod(target, "getChildrenSystemTime", GetChildrenSystemTime);
}
